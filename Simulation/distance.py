								...
								for signal_to_noise in signal_to_noise_s:
									def run_worker(run_number,
										...
										for corr_threshold in corr_threshold_s:
											...
											name = f"{sample_rate}Hz_{sample_bits}b_{center_freq}Hz_{chirp_freq}Hz_{pulse_time}s_{delay_time}s_{signal_to_noise}SNR_{corr_threshold_orig}_{speed_of_sound}m+s_{run_number}"
											r = (
												peak,
												peak_samples,
												peak_avg,
